---
layout: post
title: Webmin 1.984 File Manager
date: 2022-11-02 23:45 +0300
...
![](../../../assets/img/Exploits/webmin.png)

Webmin version 1.984 allows low-privileged authenticated users, who lack access rights to the File Manager module, to utilize file manager capabilities like changing file permissions and downloading files from remote URLs. By combining these functionalities within the file manager, a crafted .cgi file could potentially enable remote code execution.
