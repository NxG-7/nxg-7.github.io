...
![](../../../assets/img/Exploits/pfsense.png)

The presence of cross-site request forgery and cross-site scripting vulnerabilities in pfSense version 2.3.2 can be exploited remotely to gain a reverse shell as root.
