...
![](../../../assets/img/Exploits/qradar.png)

The QRadar Community Edition version 7.3.1.6 has a vulnerability that allows an authenticated attacker to instantiate arbitrary objects through user-supplied input. Exploiting this vulnerability can enable the attacker to carry out different types of attacks, including server-side request forgery and potentially executing arbitrary code.
